...
export const ResultsDisplay = ({ analysis }: ResultsDisplayProps) => {
  ...
  return (
    <div className="space-y-6 sm:space-y-8">
      {/* Score Overview */}
      <Card className="max-w-6xl mx-auto border-0 shadow-xl bg-gradient-to-br from-primary/5 to-accent/5 backdrop-blur-sm">
        <CardHeader className="text-center pb-4 sm:pb-6">
          <CardTitle className="text-2xl sm:text-3xl font-light mb-4">
            Your LinkedIn Audit Results
          </CardTitle>
          <div className="flex items-center justify-center gap-4">
            <div className="flex items-center bg-white/80 rounded-full px-6 py-3 shadow-md">
            ...
            <div className="text-center">
              ...
              <div className="text-sm text-muted-foreground">Current LinkedIn Performance</div>
            </div>
          </div>
        </CardHeader>
      </Card>
      ...
      <div className="grid gap-6 sm:gap-8 max-w-6xl mx-auto">
        ...
        <Card className="border-0 shadow-lg bg-white/95 backdrop-blur-sm">
          <CardHeader className="pb-4">
            <CardTitle className="text-xl sm:text-2xl font-semibold flex items-center text-primary">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <Card className="border-0 shadow-lg bg-gradient-to-br from-green-50 to-green-100/50">
            <CardHeader className="pb-4">
              <CardTitle className="text-lg sm:text-xl font-semibold flex items-center text-green-700">
          ...
          <Card className="border-0 shadow-lg bg-gradient-to-br from-blue-50 to-blue-100/50">
            <CardHeader className="pb-4">
              <CardTitle className="text-lg sm:text-xl font-semibold flex items-center text-blue-700">
              ...
              <ul className="space-y-3">
                {analysis.improvements.map((improvement, index) => (
                  <li key={index} className="flex items-start gap-3">
                    ...
                    <span className="text-blue-800 leading-relaxed">{improvement}</span>
                  </li>
                ))}
              </ul>
            </CardContent>
        ...
        <Card className="border-0 shadow-lg bg-white/95 backdrop-blur-sm">
          <CardHeader className="pb-4">
            <CardTitle className="text-xl sm:text-2xl font-semibold flex items-center text-purple-600">
        ...
        <Card className="border-0 shadow-lg bg-gradient-to-br from-orange-50 to-yellow-50">
          <CardHeader className="pb-4">
            <CardTitle className="text-xl sm:text-2xl font-semibold flex items-center text-orange-600">
      ...
      {/* Professional CTA */}
      <Card className="max-w-5xl mx-auto border-0 shadow-xl bg-gradient-to-br from-primary/10 to-accent/10">
        <CardContent className="text-center p-8 sm:p-12">
          ...
          <div className="bg-white/80 rounded-2xl p-6 mb-8 backdrop-blur-sm">
            <div className="flex items-center justify-center mb-4">
              <Sparkles className="h-6 w-6 mr-3 text-primary" />
              <h4 className="text-xl font-medium">Professional LinkedIn Strategy Session</h4>
            </div>
          ...
          <Button 
            ...
            className="bg-primary hover:bg-primary/90 text-white px-8 py-6 text-lg font-medium rounded-xl shadow-lg hover:shadow-xl transition-all group"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mt-8 text-sm text-muted-foreground">
