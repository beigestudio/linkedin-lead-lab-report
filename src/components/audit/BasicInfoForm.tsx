...
export const BasicInfoForm = ({
  ...
  return <Card className="max-w-3xl mx-auto border-0 shadow-2xl bg-card/80 backdrop-blur-sm border border-border/30">
        ...
        <form onSubmit={handleSubmit} className="space-y-6 sm:space-y-8">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
            <div>
              ...
              <Input type="text" placeholder="e.g., Akshara" value={profileData.name} onChange={e => onDataChange({
              ...profileData,
              name: e.target.value
            ...
            <div>
              ...
              <Input type="email" placeholder="yourname@example.com" value={profileData.email} onChange={e => onDataChange({
              ...profileData,
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
            <div>
              ...
              <Input type="text" placeholder="e.g., Founder of a SaaS startup" value={profileData.whatDoYouDo} onChange={e => onDataChange({
              ...profileData,
              whatDoYouDo: e.target.value
            })} className="h-12 sm:h-14 text-sm sm:text-base rounded-xl border-border/50 bg-background/50 backdrop-blur-sm focus:bg-background transition-all touch-manipulation" required />
            </div>
            ...
            <div>
              ...
              <Input type="text" placeholder="e.g., CMOs, founders, coaches" value={profileData.targetAudience} onChange={e => onDataChange({
              ...profileData,
          ...
          <div>
            ...
            <Input type="text" placeholder="e.g., Generate leads, Build authority" value={profileData.mainLinkedInGoal} onChange={e => onDataChange({
            ...profileData,
            mainLinkedInGoal: e.target.value
          })} className="h-12 sm:h-14 text-sm sm:text-base rounded-xl border-border/50 bg-background/50 backdrop-blur-sm focus:bg-background transition-all touch-manipulation" required />
          </div>
          
          <Button type="submit" className="w-full h-14 sm:h-16 bg-gradient-to-r from-primary to-accent hover:from-primary/90 hover:to-accent/90 text-primary-foreground text-base sm:text-lg font-medium rounded-xl shadow-lg hover:shadow-xl transition-all transform hover:-translate-y-1 touch-manipulation">
