        ...
        <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto" onPointerDownOutside={(e) => e.preventDefault()}>
          <DialogHeader>
            <div className="flex items-center justify-center mb-4">
              ...
              <DialogTitle className="text-2xl font-semibold text-foreground">Before You Start - Have These Ready</DialogTitle>
            </div>
          </DialogHeader>
          ...
          <div className="space-y-6 px-2">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h4 className="font-semibold text-foreground text-base mb-1">Your LinkedIn Headline</h4>
              ...
              <div className="flex items-start space-x-4">
                <div className="flex-shrink-0 w-7 h-7 bg-primary/20 rounded-full flex items-center justify-center mt-0.5">
                  <span className="text-primary font-semibold text-base">2</span>
                </div>
                <div>
                  <h4 className="font-semibold text-foreground text-base mb-1">Your About Section</h4>
                  <p className="text-muted-foreground text-sm leading-relaxed">
          ...
          <DialogFooter className="mt-8">
            <Button 
              ...
              size="lg"
              className="w-full bg-gradient-to-r from-primary to-accent hover:from-primary/90 hover:to-accent/90 text-primary-foreground px-8 py-4 text-lg font-medium rounded-xl shadow-lg hover:shadow-xl transition-all transform hover:-translate-y-1"
            >
