  ...
  return (
    <Card className="border-0 shadow-2xl bg-card/80 backdrop-blur-sm border border-border/30">
      ...
      <CardContent className="pt-0 px-4 sm:px-6">
        ...
        <div className="bg-gradient-to-r from-primary/10 to-accent/10 rounded-2xl sm:rounded-3xl p-6 sm:p-8 mb-8 sm:mb-10 backdrop-blur-sm border border-primary/20">
          <div className="flex items-center justify-center mb-4 sm:mb-6">
            <ClipboardList className="h-6 w-6 sm:h-7 sm:w-7 mr-2 sm:mr-3 text-primary" />
            <h3 className="text-xl sm:text-2xl font-semibold text-foreground">Before You Start - Have These Ready</h3>
          </div>
          <div className="space-y-4 sm:space-y-6">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
              <div className="flex items-start space-x-3 sm:space-x-4">
                <div className="flex-shrink-0 w-6 h-6 sm:w-7 sm:h-7 bg-primary/20 rounded-full flex items-center justify-center mt-0.5">
                  <span className="text-primary font-semibold text-sm sm:text-base">1</span>
                </div>
                <div>
                  <h4 className="font-semibold text-foreground text-sm sm:text-base mb-1">Your LinkedIn Headline</h4>
                  <p className="text-muted-foreground text-xs sm:text-sm leading-relaxed">
              ...
              <div className="flex items-start space-x-3 sm:space-x-4">
                ...
                <div>
                  <h4 className="font-semibold text-foreground text-sm sm:text-base mb-1">Your About Section</h4>
                  <p className="text-muted-foreground text-xs sm:text-sm leading-relaxed">
            ...
            <div className="bg-primary/10 rounded-xl p-4 sm:p-5">
              <p className="text-foreground text-xs sm:text-sm leading-relaxed text-center">
